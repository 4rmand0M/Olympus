...
export type Database = {
  public: {
    Tables: {
      ...
      facturas: {
        Row: { id: string; numero_factura: string; tipo_doc: string; fecha: string; cliente_id: string | null; subtotal: number; itbis: number; impuesto: number; total: number; tipo_moneda: string; metodo_pago: string; estado: string; observaciones: string | null; usuario_id: string | null; sucursal_id: string | null; created_at: string; updated_at: string }
        Insert: { id?: string; numero_factura: string; tipo_doc?: string; fecha?: string; cliente_id?: string | null; subtotal?: number; itbis?: number; impuesto?: number; total?: number; tipo_moneda?: string; metodo_pago?: string; estado?: string; observaciones?: string | null; usuario_id?: string | null; sucursal_id?: string | null; created_at?: string; updated_at?: string }
        Update: { id?: string; numero_factura?: string; tipo_doc?: string; fecha?: string; cliente_id?: string | null; subtotal?: number; itbis?: number; impuesto?: number; total?: number; tipo_moneda?: string; metodo_pago?: string; estado?: string; observaciones?: string | null; usuario_id?: string | null; sucursal_id?: string | null; created_at?: string; updated_at?: string }
      }
      factura_items: {
